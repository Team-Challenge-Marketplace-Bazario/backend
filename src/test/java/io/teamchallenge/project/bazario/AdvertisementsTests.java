...
import static io.teamchallenge.project.bazario.Helper.createAdvertisement;
import static io.teamchallenge.project.bazario.Helper.registerUserAndGetTokens;
...
class AdvertisementsTests {
    ...
    void getAdvByIdTest() throws JsonProcessingException {
        ...
        final var activeAdvertisement = createAdvertisement(webTestClient, new AdvertisementDto(null, "Adv title", "Adv description",
        ...
        final var inActiveAdvertisement = createAdvertisement(webTestClient,
                new AdvertisementDto(null, "Adv title", "Adv description",
